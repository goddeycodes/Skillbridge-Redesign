...
export default function MessagesPage(){
 ...
 return <div className="space-y-8">
  <section><span className="eyebrow"><MessageCircle size={14}/> CONNECT</span><h1 className="mt-2 text-3xl font-extrabold tracking-tight">Messages</h1><p className="mt-2 text-sm text-slate-500">Keep your learning conversations connected to the people and sessions that matter.</p></section>
